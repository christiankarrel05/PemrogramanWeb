    ...
    <div class="wrapper">
        ...
        <form action="" method="post" class="form">
            <div class="input-field">
                ...
                <input type="text" name="full_name" class="input" id="full_name" placeholder="Enter your full name" value="<?php if (isset($_POST['submit'])) { echo
                $full_name; } ?>">
            </div>
            <div class="input-field">
            ...
            <div class="input-field">
                ...
                <input type="password" name="password" class="input" id="password" placeholder="Enter your password" value="<?php if (isset($_POST['submit'])) { echo
                $password; } ?>">
            </div>
            <div class="input-field">
                <label for="cpassword" class="input-label">Confirm Password</label>
                <input type="password" name="cpassword" class="input" id="cpassword" placeholder="Enter confirm password" value="<?php if (isset($_POST['submit'])) { echo
                $cpassword; } ?>">
            </div>
